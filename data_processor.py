    ...
    try:
        ...
        for i in range(num_columns):
            if i < len(base_columns):
                ...
                column_names.append(f'ExtraColumn{i+1}')
        ...
        # CHT/EGT parameters
        for i in range(1, 7):
            engineparams[f'CHT {i} (deg C)'] = f'cht{i}'
            engineparams[f'EGT {i} (deg C)'] = f'egt{i}'
...
if name == "main":
    ...
    csv_file = '2023-08-11-SMK504-SN8601-15.3.3.4688-USER_LOG_DATA.csv'
